...
const updateProfile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updatedUser = yield userService.updateProfile({ userId, username, name, website, bio, image, gender });
        if (updatedUser) {
...
const profilePosts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const posts = yield userService.profilePosts(userId);
        if (posts) {
...
const followUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const success = yield userService.followUser({ follower_id, followed_id });
        if (success) {
...
const unfollowUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { follower_id, followed_id } = req.body;
        console.log(follower_id, followed_id);
        const success = yield userService.unfollowuser({ follower_id, followed_id });
        if (success) {
...
module.exports = { updateProfile, profilePosts, followUser, unfollowUser };
