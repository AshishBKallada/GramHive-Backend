...
const storyValidator_1 = require("../../validators/storyValidator");
...
storyRouter.post('/upload/:userId', storyUploadMiddleware_1.default, storyValidator_1.storyValidationRules.uploadStory, validationMiddleware_1.handleValidationErrors, controller.addStory.bind(controller));
