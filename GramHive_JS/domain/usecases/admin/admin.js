...
class AdminService {
    ...
    login(credentials) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { admin, token } = yield this.adminRepository.findByCredentials(credentials.email, credentials.password);
                return { admin, token };
            }
            catch (error) {
    ...
    blockUser(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const isBlocked = yield this.adminRepository.blockUser(userId);
